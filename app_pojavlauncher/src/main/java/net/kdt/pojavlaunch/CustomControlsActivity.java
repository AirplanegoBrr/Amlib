		...
		mDrawerNavigationView.setOnItemClickListener((parent, view, position, id) -> {
			switch(position) {
				...
				case 6: // Saving the currently shown control
					try {
						Uri contentUri = DocumentsContract.buildDocumentUri(Tools.getStorageProviderAuthority(this), mControlLayout.saveToDirectory(mControlLayout.mLayoutFileName));
